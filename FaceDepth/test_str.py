...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_size', default=[640, 480], type=list, help='Image size of network input')
    parser.add_argument('--data_dir', default='comarision_datasets\input', type=str, help='Data path')
